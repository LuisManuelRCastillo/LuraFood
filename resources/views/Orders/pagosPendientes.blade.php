                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 border-l-4 border-red-500">
                            ...
                            <div>
                                ...
                                <div class="flex flex-col sm:flex-row gap-2">
                                    <form action="{{ route('pedidos.marcar-pagado', $pedido->id) }}" method="POST" class="flex-1">
                                        @csrf
                                        <input type="hidden" name="payment_method" value="cash">
                                        <button type="submit"
                                                class="w-full px-3 py-3 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-bold rounded-lg transition flex items-center justify-center gap-2 text-sm">
                                    ...
                                    <form action="{{ route('pedidos.marcar-pagado', $pedido->id) }}" method="POST" class="flex-1">
                                        ...
                                        <button type="submit"
                                                class="w-full px-3 py-3 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-bold rounded-lg transition flex items-center justify-center gap-2 text-sm">
                                    ...
                                    <form action="{{ route('pedidos.marcar-pagado', $pedido->id) }}" method="POST" class="flex-1">
                                        ...
                                        <button type="submit"
                                                class="w-full px-3 py-3 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-bold rounded-lg transition flex items-center justify-center gap-2 text-sm">
